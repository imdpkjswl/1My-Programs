...
class LinkedListImplementation {
    ...
    int nthItem(Node first, int k) {
        if(first == null){
            System.out.println("List is empty.");
            return 0;
        } else if( k<=0)  // Handling negative value.
            return 0;
...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("4.Get Nth node value");
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    int k = in.nextInt();
                    int nth = list.nthItem(first, k);
                    if(nth == 0){
                        System.out.println("Invalid input entered.");
                    }
                    else
                        System.out.println("The "+k+"th value in the list is:  "+nth);
                    break;
